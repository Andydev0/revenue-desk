...
Estas possibilidades não estão implementadas:

- Persistência de snapshots, metas e histórico de vendas em PostgreSQL ou Supabase.
- Filtros por período e canal.
- Integração com Shopify e Checkout Champ.
- Eventos de rastreamento do lado do servidor.
- Metas e alertas de variação.
- Controle de acesso por função.
- Monitoramento e observabilidade da aplicação e das integrações.
